...
class UserModel {
  ...
  final List<String> favoriteBazaarIds;
  ...
  factory UserModel.fromJson(Map<String, dynamic> json) {
    return UserModel(
      ...
      favoriteBazaarIds:
          (json['favoriteBazaarIds'] as List<dynamic>?)?.cast<String>() ?? [],
  ...
  Map<String, dynamic> toJson() {
    return {
      ...
      'favoriteBazaarIds': favoriteBazaarIds,
  ...
  UserModel copyWith({
    ...
    return UserModel(
      ...
      favoriteBazaarIds: favoriteBazaarIds ?? this.favoriteBazaarIds,
